...
use KrisOzolins\LaravelPackageExample\Commands\FooCommand;
use KrisOzolins\LaravelPackageExample\Exceptions\InvalidConfiguration;

class LaravelPackageExampleServiceProvider extends ServiceProvider
{
    /**
     ...
     * @var  string
     */
    protected $vendorName = 'krisozolins';
    protected $packageName = 'laravelpackageexample';
    ...
    public function register()
    {
        ...
        $this->app->singleton(LaravelPackageExample::class, function ($app) use ($config) {
            ...
            return new LaravelPackageExample;
        });

        // Make alias for use with package name
        $this->app->alias(LaravelPackageExample::class, $this->packageName);
    }
